...
class VisitsRepository {
  ...
  /// Convert VisitsCompanion to JSON with all fields (handles Value.absent() safely)
  Map<String, dynamic> _visitCompanionToJson(VisitsCompanion visit) {
    return {
      'patient_code': _valueOrNull(visit.patientCode),
      'visit_sequence': _valueOrNull(visit.visitSequence) ?? 1,
      'visit_date': _valueOrNull(visit.visitDate)?.toIso8601String(),
      'doctor_name': _valueOrNull(visit.doctorName),
      'motif': _valueOrNull(visit.motif),
      'diagnosis': _valueOrNull(visit.diagnosis),
      'conduct': _valueOrNull(visit.conduct),
      // Right Eye (OD)
      'od_sv': _valueOrNull(visit.odSv),
      'od_av': _valueOrNull(visit.odAv),
      'od_sphere': _valueOrNull(visit.odSphere),
      'od_cylinder': _valueOrNull(visit.odCylinder),
      'od_axis': _valueOrNull(visit.odAxis),
      'od_vl': _valueOrNull(visit.odVl),
      'od_k1': _valueOrNull(visit.odK1),
      'od_k2': _valueOrNull(visit.odK2),
      'od_r1': _valueOrNull(visit.odR1),
      'od_r2': _valueOrNull(visit.odR2),
      'od_r0': _valueOrNull(visit.odR0),
      'od_pachy': _valueOrNull(visit.odPachy),
      'od_toc': _valueOrNull(visit.odToc),
      'od_notes': _valueOrNull(visit.odNotes),
      'od_gonio': _valueOrNull(visit.odGonio),
      'od_to': _valueOrNull(visit.odTo),
      'od_laf': _valueOrNull(visit.odLaf),
      'od_fo': _valueOrNull(visit.odFo),
      // Left Eye (OG)
      'og_sv': _valueOrNull(visit.ogSv),
      'og_av': _valueOrNull(visit.ogAv),
      'og_sphere': _valueOrNull(visit.ogSphere),
      'og_cylinder': _valueOrNull(visit.ogCylinder),
      'og_axis': _valueOrNull(visit.ogAxis),
      'og_vl': _valueOrNull(visit.ogVl),
      'og_k1': _valueOrNull(visit.ogK1),
      'og_k2': _valueOrNull(visit.ogK2),
      'og_r1': _valueOrNull(visit.ogR1),
      'og_r2': _valueOrNull(visit.ogR2),
      'og_r0': _valueOrNull(visit.ogR0),
      'og_pachy': _valueOrNull(visit.ogPachy),
      'og_toc': _valueOrNull(visit.ogToc),
      'og_notes': _valueOrNull(visit.ogNotes),
      'og_gonio': _valueOrNull(visit.ogGonio),
      'og_to': _valueOrNull(visit.ogTo),
      'og_laf': _valueOrNull(visit.ogLaf),
      'og_fo': _valueOrNull(visit.ogFo),
      // Shared
      'addition': _valueOrNull(visit.addition),
      'dip': _valueOrNull(visit.dip),
    };
  }
